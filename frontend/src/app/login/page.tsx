          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-4 bg-slate-50 border-2 rounded-2xl focus:bg-white outline-none transition-all font-medium ${
                      errors.identifier ? 'border-red-500' : 'border-slate-200 focus:border-brand-500'
                    }`}
                    value={identifier}
                ...
                {errors.identifier && (
                  <p className="text-xs text-red-500 font-medium ml-1">{errors.identifier}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full pl-12 pr-4 py-4 bg-slate-50 border-2 rounded-2xl focus:bg-white outline-none transition-all font-medium ${
                      errors.password ? 'border-red-500' : 'border-slate-200 focus:border-brand-500'
                    }`}
                    value={password}
        ...
        <div className="relative z-10 max-w-lg text-center">
          ...
          >
            ...
            <p className="text-xl text-brand-100 leading-relaxed">
              Experience the future of healthcare with BacancyTeleCare. Connect with experts in minutes and
